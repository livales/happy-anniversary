...
const Anniversary13 = () => {
  ...
  return (
    <div className="relative overflow-hidden">
      {/* Back Button - Fixed positioning at top */}
      <Link 
        to="/surat"
        className="fixed top-4 left-4 z-50 inline-flex items-center text-pink-600 hover:text-pink-700 transition-colors bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg"
      >
