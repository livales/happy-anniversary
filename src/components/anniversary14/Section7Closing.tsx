...
import thankyou from "../../assets/images/anniversary-14/5-thank-you.jpg";
      ...
      <div className="max-w-4xl mx-auto text-center space-y-12">
        ...
        <div className="fade-in space-y-6">
          <p className="text-lg lg:text-xl text-gray-700 leading-relaxed font-medium bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
            Terima kasih yaa sayang, udah mau jadi koki terbaik buat hubungan
            kita. Semangat terus yaa buat semua yang lagi kamu kerjain.
          </p>
        ...
        <div className="fade-in bg-gradient-to-r from-purple-100 to-pink-100 rounded-3xl p-8 shadow-lg">
          <h3 className="text-2xl font-bold text-purple-700 mb-4 font-serif">
            🎵 Ini lagu yang cocok buat kita yang lagi "masak" masa depan
            bareng:
          </h3>
        ...
        <div className="fade-in text-3xl font-bold text-pink-600 relative">
          ...
          {/* Floating hearts */}
          <div className="floating-heart absolute -top-8 -left-8 text-2xl">
            💖
          </div>
          <div className="floating-heart absolute -top-4 right-4 text-xl">
            💕
          </div>
          <div className="floating-heart absolute top-2 right-4 text-2xl">
            💝
          </div>
          <div className="floating-heart absolute -bottom-6 left-8 text-xl">
            💗
          </div>
          <div className="floating-heart absolute -bottom-8 -right-4 text-2xl">
            💓
          </div>
        </div>
      </div>
