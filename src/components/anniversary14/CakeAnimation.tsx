    ...
    <div ref={containerRef} className="w-full h-full relative">
      <svg viewBox="0 0 300 300" className="w-full h-full">
        ...
        <g className="ingredient">
          ...
          <text x="80" y="105" textAnchor="middle" fontSize="10" fill="white">
            ❤️
          </text>
        </g>
        <g className="ingredient">
          <circle cx="220" cy="120" r="15" fill="#87CEEB" />
          <text x="220" y="125" textAnchor="middle" fontSize="10" fill="white">
            ⏳
          </text>
        </g>
        <g className="ingredient">
          <circle cx="90" cy="180" r="15" fill="#FFD700" />
          <text x="90" y="185" textAnchor="middle" fontSize="10" fill="white">
            💪
          </text>
        </g>
        <g className="ingredient">
          <circle cx="210" cy="180" r="15" fill="#98FB98" />
          <text x="210" y="185" textAnchor="middle" fontSize="10" fill="white">
            🤝
          </text>
        </g>
