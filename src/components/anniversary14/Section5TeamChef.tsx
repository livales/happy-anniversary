...
import chef from "../../assets/images/anniversary-14/3-chef.jpg";
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="animate-in space-y-6 max-w-3xl mx-auto">
          <p className="text-lg lg:text-xl text-gray-700 leading-relaxed font-medium bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
            Aku seneng banget kita jadi tim koki yang hebat buat resep ini. Kamu
            jago banget nambahin 'kegigihan' dan 'kesabaran', sementara aku
            mungkin lebih sering jadi yang bagian ngicipin hehe, atau kadang
            malah bikin adonannya berantakan.
          </p>
          <p className="text-lg lg:text-xl text-gray-700 leading-relaxed font-medium bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
            Tapi yang paling penting, kita selalu bisa beresin semuanya
            bareng-bareng.
          </p>
        </div>
